...
interface SidebarCollapsible2RootProps
...
const SidebarCollapsible2Root = React.forwardRef<
  HTMLElement,
  SidebarCollapsible2RootProps
>(function SidebarCollapsible2Root(
  {
    header,
    footer,
    children,
...
export const SidebarCollapsible2 = Object.assign(SidebarCollapsible2Root, {
  NavItem,
});
