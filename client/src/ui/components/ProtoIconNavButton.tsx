...
interface ProtoIconNavButtonRootProps
...
const ProtoIconNavButtonRoot = React.forwardRef<
  HTMLElement,
  ProtoIconNavButtonRootProps
>(function ProtoIconNavButtonRoot(
  {
    ...
    >
      {icon ? (
        <SubframeCore.IconWrapper
          className={SubframeUtils.twClassNames(
            "text-heading-3 font-heading-3 text-neutral-700 group-disabled/032ae765:text-neutral-400",
            {
              hidden: loading,
              "text-body font-body": size === "small",
              "text-heading-3 font-heading-3": size === "large",
              "text-white group-hover/032ae765:text-white":
                variant === "inverse",
              "text-error-700 group-hover/032ae765:text-error-700 group-active/032ae765:text-error-700":
                variant === "destructive-tertiary" ||
                variant === "destructive-secondary",
              "text-white group-hover/032ae765:text-white group-active/032ae765:text-white":
                variant === "destructive-primary" ||
                variant === "brand-primary",
              "text-neutral-700": variant === "neutral-secondary",
              "text-neutral-700 group-hover/032ae765:text-neutral-700 group-active/032ae765:text-neutral-700":
                variant === "neutral-primary",
              "text-brand-700 group-hover/032ae765:text-brand-700 group-active/032ae765:text-brand-700":
      ...
      <SubframeCore.Loader
        className={SubframeUtils.twClassNames(
          "hidden text-caption font-caption text-neutral-700 group-disabled/032ae765:text-neutral-400",
          {
...
export const ProtoIconNavButton = ProtoIconNavButtonRoot;
