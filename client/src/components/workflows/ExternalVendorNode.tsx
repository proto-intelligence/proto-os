...
interface ExternalVendorNodeData {
  label: string;
  name: string;
  description: string;
  type: TaskType;
...
const ExternalVendorNodeComponent = ({ data }: NodeProps<ExternalVendorNodeData>) => {
  const nodeData = data as ExternalVendorNodeData;
  
  return (
    <>
      <Handle type="target" position={Position.Top} />
      <ProtoExternalVendorTask
        headerSlot={
...
export const ExternalVendorNode = memo(ExternalVendorNodeComponent); 